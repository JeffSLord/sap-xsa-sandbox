sap.ui.define([
		...
		return BaseObject.extend("lines.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias lines.model.ListSelector
			 */
			 ...
			 * @return {lines.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
