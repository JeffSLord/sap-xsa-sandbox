sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("lines/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("lines.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["lines/localService/mockserver"], function (mockserver) {
