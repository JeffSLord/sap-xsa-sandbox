sap.ui.define([
		...
		opaTest("MasterList Filtering on PAGENUMBER less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("PAGENUMBER").
				and.iSelectListItemInViewSettingsDialog("<100 TEXT").
		...
		opaTest("MasterList Filtering on PAGENUMBER more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 TEXT").
				and.iPressOKInViewSelectionDialog();
